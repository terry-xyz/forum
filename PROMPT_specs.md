...
## RULES (don't apply to `specs/SPEC.md`)
...
99999999999. Apply all rules to all existing files with up to 100 parallel Codex subagents in @specs (except SPEC.md) and create new files if determined its needed based on `specs/SPEC.md`. The names of the files should follow this name convention: <int>-filename.md, for example 01-range-optimization.md, 02-adaptive-behavior.md etc.